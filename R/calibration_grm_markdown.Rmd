...
```{r base data, eval=FALSE, echo=FALSE, include=FALSE}
...
```{r segmentation, eval=FALSE, echo=FALSE, include=FALSE}
...
```{r show segmentation 1, echo=FALSE}
polygon_forest %>%
...
```{r show segmentation 2, echo=FALSE}
...
```{r figures and tables, eval=FALSE, echo=FALSE, include=FALSE}
# Parameters
dens_threshold <- 0.1
weight_area <- 1/2
weight_shape <- 1/2
...
```{r show figures and tables 1, echo=FALSE}
# Parameters
dens_threshold <- 0.1
weight_area <- 1/2
weight_shape <- 1/2
...
```{r show figures and tables 2, echo=FALSE}
# Color scaling
...
```{r show figures and tables 3, echo=FALSE}
results_temp %>%
  arrange(final_score) %>%
  slice(1) %>%
  dplyr::select(forest, model_name, thresh, spec, spat, overlap_area_raster, overlap_shape_smoothed_raster, n_forest, n_segmentation, dens_smape, final_score) -> best_parameters_temp
