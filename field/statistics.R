...
#
#   zq95 %>%
#     writeRaster(paste0("./results/FL/", f, "_zq95_prediction.tif"))
#
# }
#
# for(f in c("RMF", "OVF")){
...
#
#   zq90 %>%
#     writeRaster(paste0("./results/FL/", f, "_zq90_prediction.tif"))
#
# }
#
#
        ...
        function(x){
          ...
          map_dfr(c("vmb_ha", "st", "dens", "dhpq", "zq90"),
                  function(y){
                    ...
                    metric <- rast(paste0("D:/00_Ontario_eFRI/random_forest/results/FL/", x, "_", y, "_prediction.tif"))
