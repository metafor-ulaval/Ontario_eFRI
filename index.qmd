...
This work represented an important proof of concept, but several issues remained before the approach could be more broadly implemented:
  ...
  * The quality of the resulting polygons needed to be evaluated using criteria that go beyond simple visual comparison with existing photo-interpreted maps.
...
The general objective of this project was to refine an automated forest stand delineation and attribution framework so that it can better support operational forest inventory modernization in Ontario.
...
5. Evaluate the quality of automated delineations
...
RMF_figure + labs(title = "Romeo Malette Forest")
OVF_figure + labs(title = "Ottawa Valley Forest")
```
