...
for(f in c("RMF", "OVF")){
  ...
  st_read(paste0("D:/00_Ontario_eFRI/03_shp_data/", f, "/PolygonForest.shp"), quiet = T) -> polygon_forest

  st_read(paste0("D:/00_Ontario_eFRI/03_shp_data/", f, "/ctg.shp"), quiet = T) %>%
  ...
  sampling_square %>%
    ...
    st_write(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/sampling_square_", f, ".shp"))
  ...
  polygon_forest %>%
    st_write(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/polygon_forest_", f,".shp"))
  ...
  list.files(paste0("D:/00_Ontario_eFRI/04_metrics/", f), full.names = TRUE) %>%
    read_metrics() %>%
    filter(name %in% m) %T>%
  ...
  # Save objects
  metrics %>%
    writeRaster(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/metrics_", f,".tif"))

  polygon_forest_FOR %>%
    st_write(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/polygon_forest_FOR_", f,".shp"))

  polygon_forest_NON_FOR %>%
    st_write(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/masks_", f,".shp"))
...
for(f in c("RMF", "OVF")){
  ...
  st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/sampling_square_", f, ".shp"),
          quiet = T) %>% 
...
#| echo = FALSE
st_read("D:/00_Ontario_eFRI/03_shp_data/OVF/PolygonForest.shp", quiet = T) -> polygon_forest

st_read("D:/00_Ontario_eFRI/03_shp_data/OVF/ctg.shp", quiet = T) %>%
  st_transform(st_crs(polygon_forest)) -> ctg
...
sf::st_read("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/polygon_forest_FOR_OVF.shp", quiet = T) %>% 
  dplyr::select() %>%
...
#| echo = FALSE
terra::rast("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/metrics_OVF.tif") -> metrics
...
future_lapply(seq_len(nrow(params)), function(p){
  ...
  st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/sampling_square_", param$forest, ".shp"),
          quiet = T) -> sampling_square

  rast(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/metrics_", param$forest,".tif")) -> metrics

  st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/masks_", param$forest,".shp"),
          quiet = T) -> masks
...
suppressMessages(
  st_read("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/segmentation/OVF/model_A/segmentation_thresh50_spec50_spat50.shp",
        quiet = T) %>% 
  sf::st_make_valid() %>%
  sf::st_cast("MULTIPOLYGON") %>%
  sf::st_cast("POLYGON") %>%
...
suppressMessages(st_read("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/segmentation/OVF/model_A/segmentation_thresh50_spec50_spat50_smoothed.shp",
        quiet = T) %>% 
  sf::st_make_valid() %>%
  sf::st_cast("MULTIPOLYGON") %>%
  sf::st_cast("POLYGON") %>%
...
# Remove done files
params %>%
  mutate(done = file.exists(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", forest, "/", model_name, "/tables/results_thresh", thresh, "_spec", spec*100, "_spat", spat*100, ".rds"))) %>%
  filter(!done) -> params
...
for(batch in indices){
  ...
  future.apply::future_lapply(batch, function(p){
    ...
    tryCatch({
      ...
      if(!dir.exists(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest))){
        dir.create(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest))
      }

      if(!dir.exists(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name))){
        dir.create(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name))
      }

      if(!dir.exists(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_nam, "/tables"))){
        dir.create(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/tables"))
      }

      if(!dir.exists(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/figures"))){
        dir.create(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/figures"))
      }
      ...
      terra::rast(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/metrics_", param$forest, ".tif")) -> metrics

      sf::st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/base_data/polygon_forest_FOR_", param$forest, ".shp"), quiet = T) %>%
        dplyr::select() %>%
        sf::st_cast("MULTIPOLYGON") %>%
        sf::st_cast("POLYGON") %>%
        mutate(area = as.numeric(sf::st_area(.)),
      ...
      sf::st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/segmentation/", param$forest, "/", param$model_name, "/segmentation", output_name, ".shp"), quiet = T) %>%
        sf::st_cast("MULTIPOLYGON") %>%
        sf::st_cast("POLYGON") %>%
        mutate(area = as.numeric(st_area(.)),
               perimeter = as.numeric(st_perimeter(.)),
      ...
      sf::st_read(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/segmentation/", param$forest, "/", param$model_name, "/segmentation", output_name, "_smoothed.shp"), quiet = T) %>%
        sf::st_make_valid() %>%
        sf::st_cast("MULTIPOLYGON") %>%
        sf::st_cast("POLYGON") %>%
        mutate(area = as.numeric(st_area(.)),
      ...
      ggsave(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/figures/area", output_name, ".jpg"),
             plot = p_area,
             width = 15,
             height = 10,
             dpi = 150)
      ...
      ggsave(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/figures/shape", output_name, ".jpg"),
             plot = p_shape,
             width = 15,
             height = 10,
             dpi = 150)
      ...
      ggsave(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/maps/map", output_name, ".jpg"),
             plot = p_map,
             width = 10,
             height = 10,
             dpi = 300)
      ...
      results %>%
        saveRDS(paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/", param$forest, "/", param$model_name, "/tables/results", output_name, ".rds"))
      ...
      cat(c("Error at index ", p, " : ", conditionMessage(e), "----------"),
          file = paste0("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/log_error/log_error_", param$forest, "_", param$model_name, "_thresh", param$thresh, "_spec", param$spec*100, "_spat", param$spat*100, ".txt"),
          append = TRUE,
          sep = "\n")
...
list.files("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results", full.names = TRUE) %>%
...
results %>%
  saveRDS("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/results.rds")
```
...
best_parameters_all %>%
  saveRDS("D:/00_Ontario_eFRI/07_analysis/segmentation/grm_parametrization/results/best_parameters_all.rds")
```
